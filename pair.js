            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'STAR-XD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [ZAIBI King GitHub Repo](https://github.com/Hassanxzoraib/)  

🚀 _Thanks for choosing STAR-AK — Let the automation begin!_ ✨`;
